...
namespace Kodigos.API.Migrations
{
    ...
    [Migration("20230730162505_Refactor_Table_Supplier")]
    partial class Refactor_Table_Supplier
    {
            ...
            modelBuilder.Entity("Kodigos.Dominio.ModelsData.Expense.ExpenseDTO", b =>
                {
                    ...
                    b.HasOne("Kodigos.Dominio.ModelsData.Administration.TypePerson.SupplierDTO", "supplier")
                        .WithMany("expense")
